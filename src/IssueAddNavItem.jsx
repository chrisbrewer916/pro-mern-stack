...
import {NavItem, Glyphicon, Modal, Form, FormGroup,
  FormControl, ControlLabel, Button, ButtonToolbar } from 'react-bootstrap';
    ...
    fetch('/api/issues', {
      ...
      if (response.ok) {
        ...
        response.json().then(error => {
          this.whoError(`Failed to add issue: ${error.message}`);
        });
      }
    }).catch(err => {
